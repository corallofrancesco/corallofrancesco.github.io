...
const home = `<main id="main">
  ...
  <div class="details">
    <p class="summary">I’m Francesco, an AI leader and hands-on developer with a background in space engineering. I focus on turning generative AI from promising experiments into measurable business impact through AI agents, software development, workflow automation, and large-scale adoption.</p>
